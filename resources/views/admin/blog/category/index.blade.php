                            ...
                            <form method="POST" action="{{ route('store.blog.category') }}">
                              @csrf
                                <div class="modal-body pd-20">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category name En" name="category_name_en">
                                    </div>

                                    <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Category name Hin</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category name Hin" name="category_name_in">
                                    </div>
                               </div>
                               <!-- modal-body -->
